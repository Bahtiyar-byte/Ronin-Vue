...
import TableSampleAppointments from '@/components/Appointments/TableSampleAppointments.vue'
...
const onConfirmCsv = async () => {
  if (csvFile.value) {
    ...
    appointmentsStore.fetch(null, query.value);
...
const externalLink = computed(() => {
  return process.env.NODE_ENV === 'production'
    ? window.location.origin + '/api-docs/#/Appointments'
    : 'http://localhost:8080/api-docs/#/Appointments';
});
...
<CardBoxModal
  ...
  <SectionHeroBar>Appointments</SectionHeroBar>
  <SectionMain>
    <BaseButtons>
      <BaseButton
        color="default"
  ...
  <SectionMain>
  <a class="text-blue-500 hover:text-blue-600 active:text-blue-700 mb-3 block" :href="externalLink">API documentation for appointments</a>
    ...
    <CardBox
      ...
      has-table
    >
      <TableSampleAppointments checkable :sortTitle="sortTitle" :sortDirection="sortDirection" @sort="sortTable($event)" />
    </CardBox>
