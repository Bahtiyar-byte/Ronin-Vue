...
<template>
  ...
  >
    ...
    <template #activator="{ props }">
      <VBtn v-bind="props" size="30" icon="tabler-eye" variant="text"> </VBtn>
    </template>
    ...
    <VCard class="p-3">
      ...
      <!-- <VDivider /> -->
      <VExpansionPanels v-models="[0, 1, 2, 3]" multiple>
        <VExpansionPanel>
        ...
        <VExpansionPanel>
          ...
          <VExpansionPanelText>
            <VTable class="text-no-wrap transaction-table">
              ...
              <tbody>
                <tr v-for="(assignment, index) in crewAssignments" :key="index">
                  <td :style="getPaddingStyle(index)">
        ...
        <VExpansionPanel>
          ...
          <VExpansionPanelText>
            <VTable class="text-no-wrap transaction-table">
              ...
              <tbody>
                <tr v-for="(instruction, index) in crewInstructions" :key="index">
                  <td :style="getPaddingStyle(index)">
