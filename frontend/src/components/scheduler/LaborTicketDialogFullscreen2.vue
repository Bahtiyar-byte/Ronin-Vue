    ...
    <VCard class="p-3">
      ...
      <VCard style="height: 95vh;">
        <VTabs v-model="currentTab">
          ...
          <VTab>Crew Instructions</VTab>
          <VTab>Crew Check In</VTab>
          <VTab>Shared Documents</VTab>
          <VTab>Shared Photos</VTab>
          <VTab>Checklist</VTab>
          <VTab>Disclaimer</VTab>
        </VTabs>
