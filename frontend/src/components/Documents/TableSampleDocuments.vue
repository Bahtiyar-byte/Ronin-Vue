...
/* Delete item */
const deleteItem = () => {
  documentsStore.deleteItem(currentId.value)
}

const items = computed(() => documentsStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/documents/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
