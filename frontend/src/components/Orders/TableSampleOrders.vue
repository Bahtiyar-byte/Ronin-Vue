...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'orderNumber' && props.sortDirection]"
        @click="sort('orderNumber')"
      >Order Number</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'totalAmount' && props.sortDirection]"
      ...
      >
        ...
        />
              ...
              <td data-label="estimateId">
                {{ dataFormatter.estimatesOneListFormatter(client.estimateId) }}
              </td>
