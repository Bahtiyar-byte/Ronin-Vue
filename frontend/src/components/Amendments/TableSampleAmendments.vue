...
amendmentsStore.fetch()

/* Delete item */
const deleteItem = () => {
  amendmentsStore.deleteItem(currentId.value)
}

const items = computed(() => amendmentsStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/amendments/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
