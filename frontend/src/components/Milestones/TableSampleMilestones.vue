...
/* Delete item */
const deleteItem = () => {
  milestonesStore.deleteItem(currentId.value)
}

const items = computed(() => milestonesStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/milestones/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
