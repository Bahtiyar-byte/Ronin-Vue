...
export const useEmailsStore = defineStore('emails', {
  ...
  actions: {
    ...
    async newItem(payload) {
      this.startLoading();
      try {
        const result = await axios.post('/emails', { data: payload });
        this.showNotification('Emails has been created', 'success');
    ...
    async edit(payload) {
      this.startLoading();
      try {
        const result = await axios.put(`/emails/${payload.id}`, {id: payload.id, data: payload.data})
        // 
        this.showNotification('Emails has been updated', 'success');
        this.getData(result.data)
      } catch (e) {
