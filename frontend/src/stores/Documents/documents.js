...
export const useDocumentsStore = defineStore('documents', {
  ...
  actions: {
    ...
    async newItem(payload) {
      this.startLoading();
      try {
        const result = await axios.post('/documents', { data: payload });
        this.showNotification('Documents has been created', 'success');
    ...
    async edit(payload) {
      this.startLoading();
      try {
        const result = await axios.put(`/documents/${payload.id}`, {id: payload.id, data: payload.data})
        // 
        this.showNotification('Documents has been updated', 'success');
        this.getData(result.data)
      } catch (e) {
