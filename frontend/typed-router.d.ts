...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'addresses-create': RouteRecordInfo<'addresses-create', '/addresses/create', Record<never, never>, Record<never, never>>,
    'addresses-details-id': RouteRecordInfo<'addresses-details-id', '/addresses/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'addresses-update-id': RouteRecordInfo<'addresses-update-id', '/addresses/update/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'contactemails': RouteRecordInfo<'contactemails', '/contactemails', Record<never, never>, Record<never, never>>,
    'contactemails-create': RouteRecordInfo<'contactemails-create', '/contactemails/create', Record<never, never>, Record<never, never>>,
    'contactemails-details-id': RouteRecordInfo<'contactemails-details-id', '/contactemails/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'contactemails-update-id': RouteRecordInfo<'contactemails-update-id', '/contactemails/update/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'contactphones': RouteRecordInfo<'contactphones', '/contactphones', Record<never, never>, Record<never, never>>,
    'contactphones-create': RouteRecordInfo<'contactphones-create', '/contactphones/create', Record<never, never>, Record<never, never>>,
    'contactphones-details-id': RouteRecordInfo<'contactphones-details-id', '/contactphones/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'contactphones-update-id': RouteRecordInfo<'contactphones-update-id', '/contactphones/update/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'contracts-client-acceptance-id': RouteRecordInfo<'contracts-client-acceptance-id', '/contracts/client-acceptance/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'estimates-client-acceptance-id': RouteRecordInfo<'estimates-client-acceptance-id', '/estimates/client-acceptance/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
